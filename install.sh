...
#     https://raw.githubusercontent.com/chrisnicholldev/ITInternal/main/install.sh | bash
#
# Usage (once public):
...
REPO="chrisnicholldev/ITInternal"
...
# ITDesk — generated by install.sh on $(date -u +"%Y-%m-%d %H:%M UTC")
...
SMTP_USER=
SMTP_PASS=
SMTP_FROM=ITDesk <itdesk@domain.local>
...
echo -e "${GREEN}${BOLD}  ITDesk installed successfully!${RESET}"
echo -e "${GREEN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo ""
